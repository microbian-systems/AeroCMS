...
public static class ThemeTokenValidator
{
    ...
    { foreach (var pair in new[] { ("base", tokens.Base100, tokens.BaseContent), ("primary", tokens.Primary, tokens.PrimaryContent), ("secondary", tokens.Secondary, tokens.SecondaryContent), ("accent", tokens.Accent, tokens.AccentContent), ("neutral", tokens.Neutral, tokens.NeutralContent), ("info", tokens.Info, tokens.InfoContent), ("success", tokens.Success, tokens.SuccessContent), ("warning", tokens.Warning, tokens.WarningContent), ("error", tokens.Error, tokens.ErrorContent) }) yield return (pair.Item1, mode, Contrast(pair.Item2, pair.Item3)); }
