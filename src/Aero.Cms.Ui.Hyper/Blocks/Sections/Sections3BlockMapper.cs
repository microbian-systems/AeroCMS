...
/// <summary>
/// Represents a class for Sections3BlockMapper.
/// </summary>
public static class Sections3BlockMapper
{
        /// <summary>
    /// ToNode method.
    /// </summary>
public static NeoPageNode ToNode(Sections3Block block) => new()
    {
        NodeId = string.Empty,
        CatalogId = "hyper.sections.3",
    ...
    /// FromNode method.
    /// </summary>
public static Sections3Block FromNode(NeoPageNode node) => new()
    {
