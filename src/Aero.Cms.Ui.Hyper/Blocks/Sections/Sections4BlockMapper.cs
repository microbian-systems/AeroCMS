...
/// <summary>
/// Represents a class for Sections4BlockMapper.
/// </summary>
public static class Sections4BlockMapper
{
        /// <summary>
    /// ToNode method.
    /// </summary>
public static NeoPageNode ToNode(Sections4Block block) => new()
    {
        NodeId = string.Empty,
        CatalogId = "hyper.sections.4",
    ...
    /// FromNode method.
    /// </summary>
public static Sections4Block FromNode(NeoPageNode node) => new()
    {
