...
/// <summary>
/// Represents a class for Faq2EditorBlockDefinition.
/// </summary>
public sealed class Faq2EditorBlockDefinition : IPageEditorBlockDefinition
{
        /// <summary>
    /// Gets or sets the Catalog Id.
    /// </summary>
public string CatalogId => "hyper.faqs.2";

        /// <summary>
    /// Gets or sets the Display Name.
    /// </summary>
public string DisplayName => "FAQ 2";

        /// <summary>
    /// Gets or sets the Description.
    /// </summary>
public string? Description => "Divider-separated accordion FAQ with chevron toggle.";
...
public bool PublicStaticSsrSafe => true;
    ...
    /// </summary>
public Type? PreviewComponentType => typeof(Faq2BlockEditorPreview);

        /// <summary>
    /// Gets or sets the Property Editor Component Type.
    /// </summary>
public Type? PropertyEditorComponentType => typeof(Faq2BlockEditor);
...
public EditorBlock CreateDefaultEditorBlock()
    {
        return new EditorBlock
        {
            ...
            MainText = "FAQs",
            Description = "",
            FaqItems = Faq2Block.DefaultItems.Select(ToEditorItem).ToList()
        };
    }
...
public NeoPageNode ToNeoPageNode(EditorBlock editorBlock)
    {
        ...
        return Faq2BlockMapper.ToNode(block);
    }
...
public BlockBase? ToBlockBase(EditorBlock editorBlock) => ToFaqBlock(editorBlock);
    ...
    private static Faq2Block ToFaqBlock(EditorBlock editorBlock)
    {
        return new Faq2Block
        {
