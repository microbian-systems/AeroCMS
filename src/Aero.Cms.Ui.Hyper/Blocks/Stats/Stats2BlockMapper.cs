...
/// <summary>
/// Represents a class for Stats2BlockMapper.
/// </summary>
public static class Stats2BlockMapper
{
        /// <summary>
    /// ToNode method.
    /// </summary>
public static NeoPageNode ToNode(Stats2Block block) => new()
    {
        NodeId = string.Empty,
        CatalogId = "hyper.stats.2",
    ...
    /// FromNode method.
    /// </summary>
public static Stats2Block FromNode(NeoPageNode node) => new()
    {
