...
namespace Aero.Cms.Ui.Neo.Primitives.Header;

/// <summary>
/// Represents a class for HeaderPrimitiveDefinition.
/// </summary>
public sealed class HeaderPrimitiveDefinition : ContainerDefinitionBase, ISlotted
{
...
public static PageEditorDefinitionDescriptor Descriptor { get; } =
        new(new HeaderPrimitiveDefinition(), new HeaderPrimitiveDefinition());

        /// <summary>
    /// Gets or sets the Catalog Id.
    /// </summary>
public override string CatalogId => "primitive.header";
        /// <summary>
...
public override string DisplayName => "Header";
    ...
    /// </summary>
public override string? Description => "Semantic page or section header container.";
        /// <summary>
...
public override int SortOrder => 4;
    ...
    /// </summary>
public override Type? PreviewComponentType => typeof(HeaderPrimitivePreview);
        /// <summary>
