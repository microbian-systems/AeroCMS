...
namespace Aero.Cms.Ui.Neo.Primitives.Portfolio;

/// <summary>
/// Represents a class for PortfolioPrimitiveDefinition.
/// </summary>
public sealed class PortfolioPrimitiveDefinition : ContainerDefinitionBase, ISlotted
{
...
public static PageEditorDefinitionDescriptor Descriptor { get; } =
        new(new PortfolioPrimitiveDefinition(), new PortfolioPrimitiveDefinition());

        /// <summary>
    /// Gets or sets the Catalog Id.
    /// </summary>
public override string CatalogId => "aero_portfolio";
        /// <summary>
...
public override string DisplayName => "Portfolio";
    ...
    /// </summary>
public override string? Description => "Portfolio grid section with project items.";
        /// <summary>
...
public override string Category => "Components";
    ...
    /// </summary>
public override string IconName => "folder";
        /// <summary>
