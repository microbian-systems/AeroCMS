...
namespace Aero.Cms.Ui.Neo.Primitives.Teams;

/// <summary>
/// Represents a class for TeamsPrimitiveDefinition.
/// </summary>
public sealed class TeamsPrimitiveDefinition : ContainerDefinitionBase, ISlotted
{
    ...
    private static readonly IReadOnlySet<NeoPageNodeKind> MembersChildKinds =
        new HashSet<NeoPageNodeKind>
        {
            NeoPageNodeKind.Primitive,
            NeoPageNodeKind.Block,
    ...
    private static readonly IReadOnlyList<ISlotDefinition> _slots = new[]
    {
        ...
        new SlotDefinition(
            Id: "members",
            DisplayName: "Members",
            AllowedChildKinds: MembersChildKinds,
            MinChildren: 1,
            MaxChildren: 30
        ),
        new SlotDefinition(
...
public static PageEditorDefinitionDescriptor Descriptor { get; } =
        new(new TeamsPrimitiveDefinition(), new TeamsPrimitiveDefinition());

        /// <summary>
    /// Gets or sets the Catalog Id.
    /// </summary>
public override string CatalogId => "aero_teams";
        /// <summary>
...
public override string DisplayName => "Teams";
    ...
    /// </summary>
public override string? Description => "Team members section with profile cards.";
        /// <summary>
...
public override string Category => "Components";
    ...
    /// </summary>
public override string IconName => "users";
        /// <summary>
