...
namespace Aero.Cms.Ui.Neo.Primitives.Contact;

/// <summary>
/// Represents a class for ContactPrimitiveDefinition.
/// </summary>
public sealed class ContactPrimitiveDefinition : ContainerDefinitionBase, ISlotted
{
    ...
    private static readonly IReadOnlySet<NeoPageNodeKind> DetailsChildKinds =
        new HashSet<NeoPageNodeKind>
        {
            NeoPageNodeKind.Primitive,
            NeoPageNodeKind.Block,
    ...
    private static readonly IReadOnlyList<ISlotDefinition> _slots = new[]
    {
        ...
        new SlotDefinition(
            Id: "details",
            DisplayName: "Details",
            AllowedChildKinds: DetailsChildKinds,
            MinChildren: 1,
            MaxChildren: 20
        ),
        new SlotDefinition(
...
public static PageEditorDefinitionDescriptor Descriptor { get; } =
        new(new ContactPrimitiveDefinition(), new ContactPrimitiveDefinition());

        /// <summary>
    /// Gets or sets the Catalog Id.
    /// </summary>
public override string CatalogId => "aero_contact";
        /// <summary>
    /// Gets or sets the Display Name.
    /// </summary>
public override string DisplayName => "Contact";
        /// <summary>
    /// Gets or sets the Description.
    /// </summary>
public override string? Description => "Contact information section with details and form.";
        /// <summary>
...
public override string Category => "Components";
    ...
    /// </summary>
public override string IconName => "mail";
        /// <summary>
