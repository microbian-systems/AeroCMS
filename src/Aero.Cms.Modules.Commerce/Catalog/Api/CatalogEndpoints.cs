...
public sealed record ListingRequest(long ProductId, string Culture, string Slug, string Name, string? ShortDescription, string? Description, string? Category, string? ImageUrl, decimal Price, decimal? CompareAtPrice, bool IsPublished, bool IsFeatured, long Version = 0)
{ public ProductListingDocument ToDocument() => new() { ProductId = ProductId, Culture = Culture, Slug = Slug, Name = Name, ShortDescription = ShortDescription, Description = Description, Category = Category, ImageUrl = ImageUrl, Price = Price, CompareAtPrice = CompareAtPrice, IsPublished = IsPublished, IsFeatured = IsFeatured, Version = Version }; }
...
public sealed record ManagerListingResponse(long Id, long ProductId, string Culture, string Slug, string Name, string? ShortDescription, string? Description, string? Category, string? ImageUrl, decimal Price, decimal? CompareAtPrice, string Currency, bool IsPublished, bool IsFeatured, long Version)
{ public static ManagerListingResponse From(ProductListingDocument listing) => new(listing.Id, listing.ProductId, listing.Culture, listing.Slug, listing.Name, listing.ShortDescription, listing.Description, listing.Category, listing.ImageUrl, listing.Price, listing.CompareAtPrice, listing.Currency, listing.IsPublished, listing.IsFeatured, listing.Version); }
