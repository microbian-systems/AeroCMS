...
{
    /// <summary>
    /// Default. We'll use whatever you supplied while creating the user. If no ID is specified, we'll fall back to Aero's default ID creation, which can be configured via Aero's Global Identifier Generation Conventions: https://Aerodb.net/docs/article-page/4.2/csharp/client-api/configuration/identifier-generation/global
    /// </summary>
    None,
    /// <summary>
