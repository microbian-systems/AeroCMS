...
/// <summary>
/// Stores culture-specific text and slug overrides for a category identifier.
/// </summary>
public sealed class CategoryTranslation : SableDocument, IAuditable, ICultureAware
{
        /// <summary>
    /// Gets or sets the category document identifier this translation describes; the reference is not enforced by this type.
    /// </summary>
public long CategoryId { get; set; }
        /// <summary>
    /// Gets or sets the culture key for this translation, defaulting to the CMS default culture without normalization.
    /// </summary>
public string Culture { get; set; } = SitesModel.DefaultCultureName;
        /// <summary>
    /// Gets or sets the required-initialized localized category label; callers remain responsible for validation.
    /// </summary>
public string Name { get; set; } = string.Empty;
        /// <summary>
    /// Gets or sets the required-initialized localized route segment; uniqueness is not established here.
    /// </summary>
